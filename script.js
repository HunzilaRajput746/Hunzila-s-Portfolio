...
const CONFIG = {
   ...
   GEMINI_API_KEY: 'AIzaSyAxCaPHQG21ujlkhjlhkjkhkjhhbVSYPdCUklIKHfilZKTAk', // Paste your API key here
    GEMINI_API_URL: 'https://generatinnnnnjelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent'
};
